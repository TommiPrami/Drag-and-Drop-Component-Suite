...
const
  DragDropSuiteVersion = 6.0;
  DragDropSuiteVersionMajor = 6;
...
const
  ...
  sDragDropCopyright: AnsiString = 'Drag and Drop Component Suite. Copyright © 1997-2023 Anders Melander';
...
const
  sClipNames: array[CF_TEXT..CF_LOCALE] of string =
...
begin
  case Value of
    Low(sClipNames)..High(sClipNames): Result := sClipNames[Value];
    17: Result := 'CF_DIBV5';
    18: Result := 'CF_MAX_XP';
